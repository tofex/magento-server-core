...
for parameter in "${parameters[@]}"; do
  if [[ "${parameter}" == "-m" ]] || [[ "${parameter}" == "-j" ]] || [[ "${parameter}" == "-d" ]] || [[ "${parameter}" == "-q" ]] || [[ "${parameter}" == "-n" ]] || [[ "${parameter}" == "-o" ]] || [[ "${parameter}" == "-a" ]] || [[ "${parameter}" == "-e" ]] || [[ "${parameter}" == "-c" ]] || [[ "${parameter}" == "-l" ]] || [[ "${parameter}" == "-k" ]] || [[ "${parameter}" == "-r" ]] || [[ "${parameter}" == "-f" ]] || [[ "${parameter}" == "-i" ]] || [[ "${parameter}" == "-b" ]] || [[ "${parameter}" == "-s" ]] || [[ "${parameter}" == "-w" ]] || [[ "${parameter}" == "-u" ]] || [[ "${parameter}" == "-g" ]] || [[ "${parameter}" == "-t" ]] || [[ "${parameter}" == "-v" ]] || [[ "${parameter}" == "-p" ]] || [[ "${parameter}" == "-z" ]] || [[ "${parameter}" == "-x" ]] || [[ "${parameter}" == "-y" ]]; then
...
parameters+=( "-j \"${magentoEdition}\"" )
parameters+=( "-d \"${magentoMode}\"" )
parameters+=( "-q \"${repositories}\"" )
  ...
  for server in "${serverList[@]}"; do
    ...
    if [[ -n "${webServer}" ]]; then
      ...
      if [[ "${serverType}" == "local" ]]; then
        ...
        executeScriptWithSSH "${server}" "${sshUser}" "${sshHost}" "${environment}" "${scriptPath}" "${hostServerParameters[@]}"
      fi
