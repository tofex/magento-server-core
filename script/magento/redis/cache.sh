...
for parameter in "${parameters[@]}"; do
  if [[ "${parameter}" == "-m" ]] || [[ "${parameter}" == "-e" ]] || [[ "${parameter}" == "-d" ]] || [[ "${parameter}" == "-r" ]] || [[ "${parameter}" == "-c" ]] || [[ "${parameter}" == "-o" ]] || [[ "${parameter}" == "-p" ]] || [[ "${parameter}" == "-w" ]] || [[ "${parameter}" == "-b" ]] || [[ "${parameter}" == "-v" ]] || [[ "${parameter}" == "-l" ]] || [[ "${parameter}" == "-x" ]]; then
