...
for parameter in "${parameters[@]}"; do
  if [[ "${parameter}" == "-m" ]] || [[ "${parameter}" == "-e" ]] || [[ "${parameter}" == "-d" ]] || [[ "${parameter}" == "-r" ]] || [[ "${parameter}" == "-c" ]] || [[ "${parameter}" == "-n" ]] || [[ "${parameter}" == "-v" ]] || [[ "${parameter}" == "-o" ]] || [[ "${parameter}" == "-p" ]] || [[ "${parameter}" == "-u" ]] || [[ "${parameter}" == "-w" ]] || [[ "${parameter}" == "-b" ]] || [[ "${parameter}" == "-a" ]] || [[ "${parameter}" == "-k" ]] || [[ "${parameter}" == "-g" ]] || [[ "${parameter}" == "-l" ]] || [[ "${parameter}" == "-f" ]] || [[ "${parameter}" == "-t" ]] || [[ "${parameter}" == "-z" ]] || [[ "${parameter}" == "-x" ]] || [[ "${parameter}" == "-y" ]]; then
